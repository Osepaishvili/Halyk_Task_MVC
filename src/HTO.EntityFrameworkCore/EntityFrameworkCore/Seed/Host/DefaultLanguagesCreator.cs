...
namespace HTO.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly HTODbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = HTOConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(HTODbContext context)
        {
            _context = context;
        }
